                                ...
                                <ListItem>
                                  ...
                                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, width: '100%', justifyContent: 'center' }}>
                                    ...
                                    <InfoPopover
                                      ...
                                      content={`Die Wasserreserve ist die geschätzte Feuchtigkeit, die dem Rasen aktuell im Boden zur Verfügung steht. Aktuell: ${response.soilStorageMm.toFixed(1)} mm von ${response.tawMm.toFixed(0)} mm. ${response.tawMm.toFixed(0)} mm ist die maximale Reserve des Rasenbodens.`}
                                      iconSize={16}
                                    />
                                  </Box>
                                </ListItem>
