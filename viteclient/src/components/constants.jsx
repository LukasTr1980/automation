// constants.js
export const daysOfWeek = ['Sonntag', 'Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag'];
export const daysOfWeekNumbers = {
  'Sonntag': 0,
  'Montag': 1,
  'Dienstag': 2,
  'Mittwoch': 3,
...
export const switchDescriptions = ['Stefan Nord', 'Stefan Ost', 'Lukas Süd', 'Lukas West', 'Alle'];
export const bewaesserungsTopics = [
